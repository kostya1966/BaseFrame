 ...
 * @author Kostya
 */
public class Editr extends javax.swing.JEditorPane {
...
//    public JScrollPane SCROLL;//
    ...
    public Editr(final Formr THISFORM, String name, String title, int width, int height) {//иницилизация имени поля и заголовка и размеров
        super.setText(title);
        super.setName(name);
...
//            System.out.print(" key:"+e.getExtendedKeyCode()+"\n"); 
    ...
    public Editr(String name, String title, int width, int height) {//иницилизация имени поля и заголовка и размеров
        super.setText(title);
        super.setName(name);
        super.setSize(width, height);
        this.setEditable(true);
